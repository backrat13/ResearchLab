Python developer. Currently learning Rust. With ~1-year experience building and running Multi-Agent Simulations with different configs 
Driven to contribute to  any open-source project. 

Currently trying to build on my networking
...
My Cashapp tag is: $frankhymer85
